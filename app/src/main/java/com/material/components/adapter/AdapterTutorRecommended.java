...
public class AdapterTutorRecommended extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    public List<Tutor> tutorList = new ArrayList<>();
    private OnClickListener onClickListener = null;

    public AdapterTutorRecommended(List<Tutor> tutorList) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_recommended_tutor,parent,false);
