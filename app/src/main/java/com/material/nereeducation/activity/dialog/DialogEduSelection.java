package com.material.nereeducation.activity.dialog;
...
public class DialogEduSelection extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edu_selection);
    ...
    private void initToolbar() {
        ...
        getSupportActionBar().setTitle("Education Year");
