...
public class FragmentTabsEvents extends Fragment {

    public FragmentTabsEvents() {
    }

    public static FragmentTabsEvents newInstance() {
        FragmentTabsEvents fragment = new FragmentTabsEvents();
        return fragment;
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View root = inflater.inflate(R.layout.fragment_tabs_events, container, false);
